    ...
    <div class="row">
        <div class="col-lg-12 bg-white mx-auto mt-5">
            ...
            <div class="card bg-white">
                <h4 class="card-header">All Teachers</h4>
                        ...
                        <form action="/student-search" method="GET">
                            <div class="form-group row" >
                                ...
                                <div class="col-md-6 ml-0" >
                                    ...
                                    <span class="float-right col-md-6 addBtn" ><a href="{{route('add-teacher-form')}}" class="btn btn-success float-right">+Add</a></span>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table table-bordered mb-0">
                            ...
                            @foreach ($teachers as $teacher)
                                ...
                                <tr>
                                    ...
                                    <td>{{$teacher->email}}</td>
                                    <td><img src="{{asset('image/upload/'.$teacher->image)}}" width="70px" height="70px" alt="image"></td>
                                    <td>
                                        <a href="/update-teacher-form/{{$teacher->id}}" class="btn btn-success btn-sm" title="Update">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        {{-- <a href="#" id="detail" class="btn btn-primary btn-sm"  title="Detail" data-toggle="modal" data-target="#detailModal{{$student->id}}">
                                            <i class="fa fa-eye"></i>
                                        </a> --}}
{{--                                        <a  class="btn btn-danger btn-sm" id="delete" title="Delete" href="javascript:void(0)" data-url="{{ route('studentInfo', $student->id) }}" >--}}
{{--                                            <i class="fa fa-trash"></i>--}}
{{--                                        </a>--}}
                                        <a href="/teacher-delete/{{$teacher->id}}" class="btn btn-danger btn-sm">
                                            <i class="fa fa-trash"></i>
                                        </a>
                                    </td>
                        ...
                        {{-- <div class="d-flex">{{$teachers->onEachSide(5)->links()}}</div> --}}
