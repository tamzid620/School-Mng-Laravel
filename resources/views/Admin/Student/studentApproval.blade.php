    ...
    <div class="row">
        <div class="col-lg-12 bg-white mx-auto mt-5">
            ...
            <div class="card bg-white">
                <h4 class="card-header">Pending Students</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/student-edit/{{$student->id}}" class="btn btn-success btn-sm" title="Update">
                                            {{-- <i class="fa fa-edit">Edit and Approve</i> --}}
                                            Edit
                                        </a>
                                        <a href="/student-accept/{{$student->id}}" class="btn btn-primary btn-sm" title="Update">
                                            {{-- <i class="fa fa-edit">Edit and Approve</i> --}}
                                            Approve
                                        </a>
